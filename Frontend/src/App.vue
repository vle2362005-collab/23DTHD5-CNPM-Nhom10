...
// Weekly analytics and chart states for Dashboard
...
const totalInterventions = computed(() => {
  return warnings.value.filter(w => w.IsAcknowledged).length
})
            ...
            <div class="stat-grid">
              ...
              <div class="stat-card">
                <div class="stat-info">
                  ...
                  <span class="stat-value">{{ sales.length }} đơn</span>
              ...
              <div class="stat-card">
                <div class="stat-info">
                  ...
                  <span class="stat-value">{{ warnings.length }} ca</span>
            ...
            <div class="dashboard-grid">
              ...
              <div class="analytics-main-column">
                ...
                <div class="grid-card">
                  ...
                  <table class="dashboard-table">
                    ...
                    <tbody>
                      <tr v-for="sale in sales.slice(0, 3)" :key="sale.SaleId">
              ...
              <div class="analytics-side-column">
                ...
                <div class="grid-card recent-warnings-feed">
                  ...
                  <div class="warnings-feed-container" v-if="warnings.length > 0" style="display: flex; flex-direction: column; gap: 14px;">
                    <div v-for="w in warnings.slice(0, 2)" :key="w.WarningId" class="feed-item" style="border-left: 3px solid var(--danger); padding-left: 12px; display: flex; flex-direction: column; gap: 4px;">
